...
if __name__ == '__main__':
    ...
    PRETRAIN = False
    if PRETRAIN == True:
        #pretraining with eeg_label
        dataset = Dataset(eeg_label, Text) 
    else:
        #real training with eeg
        dataset = Dataset(eeg, Text) 
        model_file='../checkpoints/Semantic/epoch200_eeg2text_40_classes.pt'
        #model_file='../checkpoints/Semantic/eeg2text.pt'
    ...
    if PRETRAIN == True:
        torch.save({'state_dict': model_dict}, f'../checkpoints/Semantic/pretrain_eeg2text.pt')
    else:
        torch.save({'state_dict': model_dict}, f'../checkpoints/Semantic/epoch200_eeg2text_40_classes.pt')
