...
#eeg = torch.load('EEG2Video/EEG2Video_New/Semantic/text_embeddings/block7.pt',map_location='cpu',weights_only=False)
#eeg = rearrange(eeg, 'a b c -> a (b c)')  # [200, 77*768]
eeg = torch.load('EEG2Video/EEG2Video_New/Semantic/sub1_session7_embeddings.pt',map_location='cpu',weights_only=False)
...
latents_add_noise = torch.load('EEG2Video/EEG2Video_New/DANA/40_classes_latent_add_noise.pt')
